...
export default function DescriptionPrivacy() {
  return (
    <section>
      <center>
        <SectionTitle>Privacy Policy of EnerSea Transport Inc.</SectionTitle>
      </center>
      <SectionText className="mt-3">
        ...
        <br />
        <br />
        EnerSea Transport Inc. operates the www.EnerSea.com website, which provides the SERVICE.
        ...
        EnerSea Transport website. If you choose to use our Service, then you agree to the
        ...
        your information with anyone except as described in this Privacy Policy. The terms used in
        this Privacy Policy have the same meanings as in our Terms and Conditions, which is
        accessible at www.EnerSea.com, unless otherwise defined in this Privacy Policy. Our Privacy
        Policy was created with the help of the Privacy Policy Template.
        <br />
        <br />
        ...
        improve our Service. You have the option to either accept or refuse these cookies, and know
        ...
        contact us. Links with contact information have been provided using the navigation bar above
        or listed below.
        <br />
        <br />
      </SectionText>
