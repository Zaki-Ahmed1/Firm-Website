...
export default function DescriptionTerms() {
  return (
    <section>
      <center>
        <SectionTitle>Terms and Conditions of EnerSea Transport Inc.</SectionTitle>
      </center>
      <b>Introduction</b>
      <SectionText className="mt-3">
        These Website Standard Terms and Conditions written on this webpage shall manage your use of
        our website, EnerSea Transport accessible at www.EnerSea.com. These Terms will be applied
        fully and affect to your use of this Website. By using this Website, you agreed to accept
        all terms and conditions written in here. You must not use this Website if you disagree with
        any of these Website Standard Terms and Conditions.
      </SectionText>
      <b>Intellectual Property Rights</b>
      <SectionText>
        Other than the content you own, under these Terms, EnerSea Transport Inc. and/or its
      ...
      <SectionText>
        ...
        Certain areas of this Website are restricted from being access by you and EnerSea Transport
        Inc. may further restrict access by you to any areas of this Website, at any time, in
        ...
        Content, you grant EnerSea Transport Inc. a non-exclusive, worldwide irrevocable, sub
        licensable license to use, reproduce, adapt, publish, translate and distribute it in any and
        all media. Your Content must be your own and must not be invading any third-party’s rights.
        EnerSea Transport Inc. reserves the right to remove any of Your Content from this Website at
        ...
        <br />
        <br />
        This Website is provided as is, with all faults, and EnerSea Transport Inc. express no
        ...
        <br />
        <br />
        In no event shall EnerSea Transport Inc., nor any of its officers, directors and employees,
        shall be held liable for anything arising out of or in any way connected with your use of
        this Website whether such liability is under contract. EnerSea Transport Inc., including its
        ...
        <br />
        <br />
        You hereby indemnify to the fullest extent EnerSea Transport Inc. from and against any
        ...
        <br />
        <br />
        EnerSea Transport Inc. is permitted to revise these Terms at any time as it sees fit, and by
        ...
        <br />
        <br />
        The EnerSea Transport Inc. is allowed to assign, transfer, and subcontract its rights and/or
        ...
        <br />
        <br />
        These Terms constitute the entire agreement between EnerSea Transport Inc. and you in
        ...
        us, and you submit to the non-exclusive jurisdiction of the state and federal courts located
        in us for the resolution of any disputes.
        <br />
        <br />
      </SectionText>
    </section>
